...
function Export-DomainList {
    ...
    $Lines  = @()
    $Lines += "# ====================================================="
    $Lines += "# BLOCK-TELEMETRY v5.2 — Export liste de blocage"
...
<header>
  ...
  <div class="meta-bar">
    ...
    <span>Date : <b>$(Get-Date -Format "dd/MM/yyyy HH:mm:ss")</b></span>
    <span>Statut : <b>$StatusText</b></span>
  </div>
</header>
<div class="container">
...
<footer>Block-Telemetry v5.2 — Rapport généré automatiquement</footer>
...
function Invoke-SelfTest {
    ...
    Write-Host ""
    Write-Host "  === SELFTEST Block-Telemetry v5.2 ===" -ForegroundColor Cyan
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDhYIPbsk0c4DPe
# QuMrCdxs9dQLdUDr3ppmmNImE2vON6CCAygwggMkMIICDKADAgECAhB6X4r8AlBU
...
# ARUwLwYJKoZIhvcNAQkEMSIEINyEiOqnD+oRsHBoYz/pu4PBdUYFADrn2+AVpP/e
# R1jcMA0GCSqGSIb3DQEBAQUABIIBAKfThtBbiE/GKfINeVg9M///lzuBHLeh5wKu
# p+v4abtJbIx3Wq9IDBH2hiJXdurqjNHJcQr/kyee71qVX+mvXb3os9dE9F8aLHEh
# JGgJEujdkS3i1itcKIRoph9nvSUviLjkMrQnoQxhvf6rM3BerveFsA6/rvWic6av
# aa43hvvQi6C5KMniBiBGX6Jup1pVsN8yv1RC4HIhMQsjBU/rNpta+KfDfU205zVN
# Cv4+wWYjyq6ri1x2JStN344eY7TH9vDTRe5bm3oTvYGCmvwRx3rQ427v+jMVvwhv
# 8OqfdGX7fpGcmA/ZoKzcRANBsVjpqqkVcq3M/u8syMYFIHPeG1g=
